...
function addNewEvent() {
    ...
    let day = new Date(document.getElementById("new-date").value).toLocaleDateString("default", {day: "2-digit"});
    let month = new Date(document.getElementById("new-date").value).toLocaleDateString("default", {month: "short"});
    let year = new Date(document.getElementById("new-date").value).toLocaleDateString("default", {year: "numeric"});
